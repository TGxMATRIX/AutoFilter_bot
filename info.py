...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", 📂Fɪʟᴇɴᴀᴍᴇ : {file_name}╔═════•✧❅✦❅✧•═════╗▣ ​<a href={https://t.me/filesharebotusers}> AML UPDATES </a>╚═════•✧❅✦❅✧•═════╝JOIN, SHARE & SUPPORT
